...
- Copy from a [USB Flash Drive](https://en.wikipedia.org/wiki/USB_flash_drive)
...
- **XFCE x64** (Default):
  ...
  or
  [HTTP](https://csel-archive.cs.colorado.edu/vm-images/cu-cs-vm-fall16-xfce-x64-v1.0.zip)
